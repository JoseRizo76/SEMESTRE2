 ...
 //MENU QUE PARA RECARGAR O AGREGAR CUENTA 
  if (opc == 2 && contador > 0 && Cverificacion == true && subopc == 0){
    ...
    if (kye2){
      ...
      case '4': 
        estadotiempo = false; Producto1 = 2; Producto2 = 2; Producto3 = 2; Producto4 = 2; lcd.clear(); cr(); lcd.print("REABASTECIMIENTO"); cr2(); lcd.print("EXITOSO"); delay(500); lcd.clear(); band_default(); break;
...
//RETIRO DE PRODUCTO DEPENDIENDO DE LA FORMA DE INGRESO DE ID Y CONTRASEÑA
  ...
  if (opc == 1 && retiroProducto == true ){
    if (SelecProducto == 0){
      ...
      if (key){
        switch (key){
          case '1': SelecProducto = 1; lcd.clear(); cr(); lcd.print("MAXIMO-> "); lcd.print(Producto1); delay(500); lcd.clear(); cr(); lcd.print("PRODUC. SELECCIONADO:"); cr2(); lcd.print("GALLETA $20");cl(); lcd.print("CANTIDAD -> "); precio = 20; break;
...
void nombre() {
  cr();
  lcd.print("SNACK VENDING MACHIN");
}
